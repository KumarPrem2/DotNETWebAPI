...
}).ConfigureApiBehaviorOptions(options =>
{
    ...
    {
        Link = "https://httpsstatuscode/500",
        Title = "Something went wrong, please contact support",
    };
    options.ClientErrorMapping[StatusCodes.Status401Unauthorized] = new Microsoft.AspNetCore.Mvc.ClientErrorData
    {
        Link = "https://httpsstatuscode/401",
        Title = "Unauthorized user access, please login first and pass the right credential",
    };
});
